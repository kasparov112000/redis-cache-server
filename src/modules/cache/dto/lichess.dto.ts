...
export class LichessExplorerSetDto {
  ...
  @ApiProperty({ description: 'Lichess explorer response data' })
  @IsObject()
...
export class LichessExplorerDataDto {
  ...
  @ApiProperty({ description: 'Available moves', type: [Object] })
...
export class LichessCacheInfoDto {
  ...
  @ApiPropertyOptional({ description: 'Cached data if exists' })
  data?: LichessExplorerDataDto;
}
